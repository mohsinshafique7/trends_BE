  ...
  _createClass(GoogleTrendsController, null, [{
    ...
    value: function () {
      var _GetIntrestByRegion = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ctx, next) {
        var _ctx$request$body, searchValues, startDate, endDate, region, category, proxyAgent, params, grossData, result, i, chunk, groupedData, initialData, _loop, z;
    ...
    value: function () {
      var _GetIntrestOverTime = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(ctx, next) {
        var _ctx$request$body2, searchValues, startDate, endDate, region, category, proxyAgent, params, grossData, result, i, chunk, groupedData, initialData, _loop2, z, sortedData;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 16:
                ...
                chunk = params.slice(i, i + 5);
                _context2.next = 20;
                return _googleTrends["default"].getIntrestOverTime(chunk, startDate, endDate, region, category, proxyAgent);
              ...
              case 25:
                ...
                _loop2 = function _loop2(z) {
                  var index = groupedData.findIndex(function (x) {
                    return x.date == initialData[z].date;
                  });

                  if (index === -1) {
                    groupedData.push(initialData[z]);
                  } else {
                    var _groupedData$find$val;

                    (_groupedData$find$val = groupedData.find(function (x) {
                      return x.date === initialData[z].date;
                    }).value).push.apply(_groupedData$find$val, _toConsumableArray(initialData[z].value));
                  }
                };
                ...
                sortedData = groupedData.reduce(function (acc, item, index) {
                  acc.push({
                    name: params[index],
                    data: groupedData.map(function (data) {
